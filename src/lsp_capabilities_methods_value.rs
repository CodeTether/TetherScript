//! Methods on core values: strings, lists, maps, and `Result`.
//!
//! Ported from `editor/vscode/lib/method-data.js`.
//!
//! # Examples
//!
//! ```rust
//! use tetherscript::lsp_capabilities::methods_value::TABLE;
//! assert!(TABLE.iter().any(|entry| entry.0 == "split"));
//! ```

use crate::lsp_capabilities::methods::Method;

/// Value methods as `(name, receiver_signature, summary)` rows.
#[rustfmt::skip]
pub const TABLE: &[Method] = &[
